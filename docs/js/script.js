...
const CONFIG = {
    ...
    /* -----------------------------------------------
       ...
       -----------------------------------------------
       !! BEFORE LAUNCH: verify this key is completely locked down in
       Google Cloud console — referrer restrictions allowing only our
       real domains, API restrictions limited to Maps JavaScript +
       Places. Full checklist comment sits above the Maps <script> tag
